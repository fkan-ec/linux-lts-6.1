...
#define MIN_RX_QUEUES_WITH_ECPRI	2	// One for ecpri
#define MIN_TX_QUEUES_WITH_ECPRI	2	// One for ecpri
#define MIN_TX_QUEUES_WITH_ECPRI_L	5	// Four ecpri for XLGMAC
...
#define ECPRI_XLGMAC_TX_PER_Q_DESC_SIZE	0x100
